...
BOOST_CLASS_EXPORT_IMPLEMENT (aslam::Frame<
    aslam::cameras::MaskedPinholeCameraGeometry>);

namespace aslam {

template void Frame<aslam::cameras::MaskedPinholeCameraGeometry>::save<>(
    boost::archive::text_oarchive & ar, const unsigned int version) const;
template void Frame<aslam::cameras::MaskedPinholeCameraGeometry>::load<>(
