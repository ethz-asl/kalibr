...
BOOST_CLASS_EXPORT_IMPLEMENT (aslam::Frame<
    aslam::cameras::PinholeRsCameraGeometry>);

namespace aslam {

template void Frame<aslam::cameras::PinholeRsCameraGeometry>::save<>(
    boost::archive::text_oarchive & ar, const unsigned int version) const;
template void Frame<aslam::cameras::PinholeRsCameraGeometry>::load<>(
